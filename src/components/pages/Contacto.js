    ...
    <>
      ...
      <div className="p-10 bg-black-100 max-w-4xl mx-auto sm:flex items-center ">
        <div className="sm:flex-1">
          <h1 className='animate-slide-left text-left px-6 text-neutral-100 font-bold text-4xl pb-8 pt-22 sm:text-center'><span className='font-bold text-5xl'>¿Te interesa</span> saber más información? <span className='text-amarillo'>¡Contáctanos!</span></h1>
        ...
        <div className="flex-none sm:w-1/2">
          <form className="bg-amarillo p-8 rounded-lg shadow-lg" onSubmit={handleSubmit}>
            <div className="mb-4">
              <label className="block text-sm text-neutral-900 mb-2" htmlFor="name">Nombre:</label>
            ...
            <div className="mb-4">
              <label className="block text-sm mb-2 text-neutral-900" htmlFor="email">Correo electrónico: </label>
            ...
            <div className="mb-4">
              <label className="block text-sm mb-2 text-neutral-900" htmlFor="message"> Mensaje: </label>
