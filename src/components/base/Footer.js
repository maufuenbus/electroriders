...
const Footer = () => {
  return (
    ...
    <footer className="relative bottom-0 w-full">
      <div className="footer bg-amarillo p-4 text-negro">
        <nav>
    ...
    <footer>
      ...
      <nav>
        ...
        <nav>
          ...
          <h1>+56 984058436</h1> 
          <a className="link link-hover" href="mailto:ariel.echeverria.12@sansano.usm.cl">ariel.echeverria.12@sansano.usm.cl</a> 
        </nav> 
        <nav>
      ...
      <div className="footer footer-center p-2 bg-negro text-base-content">
        <aside>
